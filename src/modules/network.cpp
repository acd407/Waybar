...
auto waybar::modules::Network::update() -> void {
  ...
  auto text = fmt::format(
      ...
      fmt::arg("bandwidthDownBits", pow_format(bandwidth_down * 8000ull / interval_.count(), "b/s")),
      fmt::arg("bandwidthUpBits", pow_format(bandwidth_up * 8000ull / interval_.count(), "b/s")),
      fmt::arg("bandwidthTotalBits",
               pow_format((bandwidth_up + bandwidth_down) * 8000ull / interval_.count(), "b/s")),
      fmt::arg("bandwidthDownOctets", pow_format(bandwidth_down * 1000ull / interval_.count(), "o/s")),
      fmt::arg("bandwidthUpOctets", pow_format(bandwidth_up * 1000ull / interval_.count(), "o/s")),
      fmt::arg("bandwidthTotalOctets",
               pow_format((bandwidth_up + bandwidth_down) * 1000ull / interval_.count(), "o/s")),
      fmt::arg("bandwidthDownBytes",
               pow_format(bandwidth_down * 1000ull / interval_.count(), "B/s")),
      fmt::arg("bandwidthUpBytes", pow_format(bandwidth_up * 1000ull / interval_.count(), "B/s")),
      fmt::arg("bandwidthTotalBytes",
               pow_format((bandwidth_up + bandwidth_down) * 1000ull / interval_.count(), "B/s")),
      fmt::arg("bandwidthDownBytes5w", pow_format5w(bandwidth_down * 1000ull / interval_.count())),
      fmt::arg("bandwidthUpBytes5w", pow_format5w(bandwidth_up * 1000ull / interval_.count())),
      fmt::arg("bandwidthTotalBytes5w",
               pow_format5w((bandwidth_up + bandwidth_down) * 1000ull / interval_.count())));
